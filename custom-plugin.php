...
defined( 'ABSPATH') or die( "I am veinsmoke! You can't play with me like that!");
...
function custom_plugin_setting_page() {
    ...
    add_menu_page('Custom Plugin', 'Taha Footer Setting', 'manage_options', 'custom-plugin-setting-url', 'custom_page_html_form' , plugins_url('custom-plugin/img/icons8-oil-storage-tank-16.png'));
    ...
    function custom_page_html_form() { ?>
        <div class="wrap">
            <h2>Taha Footer Plugin Setting</h2>
...
add_action( 'wp_footer', 'veinsmoke');
